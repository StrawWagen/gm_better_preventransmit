-- FROM CAMPAIGNENTS
-- https://github.com/StrawWagen/campaign_entities/blob/main/lua/autorun/server/get_prevent_transmit_campaignents.lua

if CAMPAIGN_ENTS then return end -- yield to campaignents
